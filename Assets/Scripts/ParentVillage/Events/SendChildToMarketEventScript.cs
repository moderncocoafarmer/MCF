...
public class SendChildToMarketEventScript : InteractableBuildingEventScript
{
    ...
    protected override string ChildSelectedDescription
    {
        get
        {
            ...
            return "Do you wish to send " + ChildManager.Instance.SelectedChild.Name + " to the market to buy food for the family? ( CFA " + CostToPerform.ToString() + " )";
        }
    }
    ...
    public override int CostToPerform { get { return 31980 * ChildManager.Instance.ChildCount; } }
    ...
    {
        ChildManager.Instance.ApplyEventToAllChildren(new DataPacket(10, 0, 0, 20));
    }
}
